    ...
    <div className="bg-custom-green min-h-screen">
      <div className="flex flex-col justify-center items-center w-7/12 my-0 mx-auto min-h-screen">
        ...
        <button
          ...
          className="text-custom-black w-72 h-12 flex items-center justify-center space-x-2 mt-6 rounded-full kakao-button font-semibold hover:border-transparent"
        >
